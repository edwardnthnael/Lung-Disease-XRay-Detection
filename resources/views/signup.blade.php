...
<head>
    ...
    <title>Scan X-ray - Register</title>
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder"><span
                                        class="text-capitalize">X</span>-ray</span>
                            </a>
                        </div>

                        <p class="mb-4 text-center">Create your account and begin your journey!</p>

                        <form id="formSignUp" class="mb-3" action="{{ url('sign-up') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <button class="btn btn-primary d-grid w-100" type="submit" id="btnSignUp">Sign
                                up</button>
                        </form>
        ...
        $(document).ready(function() {
            $('#formSignUp').submit(function(e) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    beforeSend: function() {
                        $('#btnSignUp').prop("disabled", true).html("Please wait...");
                    },
